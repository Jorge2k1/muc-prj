...
// Muestra la lista de amigos actualizados
...
//             friendElement.textContent = friend.username; // Asumiendo que cada amigo tiene una propiedad username
//             friendElement.addEventListener('click', function() {
//               openChatWindow(friend.username, friend.userId); // Asumiendo que cada amigo tiene una propiedad userId
//             });
